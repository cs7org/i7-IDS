...
parser.add_argument(
    "--output_dir",
    type=str,
    default="/home/hpc/iwi7/iwi7101h/i7-IDS/results/adversarial_blocking_binary",
...
clf_adv_ae_models = [
    ...
    # ],
    [
        Path("image_classification2/mobilenet_v3_large_nosampling_binary"),
        Path("image_classification/mobilenet_v3_large_nosampling_binary_adv"),
        Path("autoencoder/rdunet_normal_no_clf"),
    ],
    [
        Path("image_classification2/mobilenet_v3_large_normalized_nosampling_binary"),
        Path("image_classification/mobilenet_v3_large_normalized_nosampling_binary_adv"),
