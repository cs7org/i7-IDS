    ...
    def packets_to_labelled_sessions(
        ...
        for sess_idx, row in df.iterrows():
            ...
            end_dt = start_dt + pd.Timedelta(
                microseconds=df.iloc[0]["Flow Duration"], seconds=self.correction_sec
            )
            # convert to seconds
...
if __name__ == "__main__":
    timeout = 120
    pcap_root = Path(r"C:\Users\Viper\Desktop\thesis_code\data\iec104")
    out_dir = Path(r"C:\Users\Viper\Desktop\thesis_code\data\iec104") / "sessions"
